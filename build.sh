...
for t in rdt.PacketTest rdt.ChannelTest rdt.NetEmSmokeTest rdt.SeqSpaceTest rdt.TimerWheelTest rdt.RttEstimatorTest rdt.GoBackNTest; do echo "== $t" java -cp build/classes $t done
