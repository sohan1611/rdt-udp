...
for t in rdt.PacketTest rdt.ChannelTest rdt.NetEmSmokeTest rdt.SeqSpaceTest rdt.TimerWheelTest rdt.RttEstimatorTest rdt.ReceiveBufferTest rdt.RunStatsTest rdt.TraceLogTest; do
  echo "== $t"
